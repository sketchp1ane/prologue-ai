  ...
  return (
    <AppCard padding="lg">
      <AppCardHeader
        ...
        description="Read-only bullet records regenerated from parsed experience and projects."
      />
      <AppCardContent>
        {groups.length > 0 ? (
              ...
              >
                <div className="mb-3 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                  <h3 className="text-sm font-medium text-foreground">
                    {group.sectionTitle || "Untitled section"}
                  </h3>
          ...
          <div className="rounded-xl border border-dashed border-border bg-secondary/20 p-6 text-sm leading-6 text-muted-foreground">
            No bullet records yet. Parse this resume to generate read-only
            bullets from experience and project sections.
          </div>
        )}
      </AppCardContent>
    </AppCard>
